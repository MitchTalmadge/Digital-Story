...
const config = {
    ...
    entry: {
        polyfills: path.join(__dirname, '../src/web/polyfills.ts'),
        vendor: path.join(__dirname, '../src/web/vendors/vendors.ts'),
        main: path.join(__dirname, '../src/web/main.ts')
    },
    ...
    plugins: [
        ...
        // Fix for https://github.com/angular/angular/issues/20357
        new webpack.ContextReplacementPlugin(/@angular(\|\/)core(\|\/)esm5/, path.join(__dirname, '../src/web/'))
    ],
